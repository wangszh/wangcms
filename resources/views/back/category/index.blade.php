                  ...
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <!--tr-th end-->
                        ...
                        <td>
                            <a href="{{ route('admin.category.index') }}/{{$value->id}}/edit"><i class="fa fa-fw fa-pencil" title="修改"></i></a>  
                            <a href="javascript:void(0);"><i class="fa fa-fw fa-link" title="查看"></i></a>  
                            <a href="javascript:void(0);"><i class="fa fa-fw fa-minus-circle delete_item" title="删除" data-id="{{$value->id}}"></i></a>
                        </td>
						
                       <td class="text-green">{{$value->slug}}
                         
                        </td>
                        <td class="text-red">{{ count( $value->content()->get() ) }}</td>
