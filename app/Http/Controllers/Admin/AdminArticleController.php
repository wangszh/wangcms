...
class AdminArticleController extends BackController
{
    ...
    public function create()
    {
        ...
        $categories=Meta::all()->toArray();
        $select=Tree::dropDownSelect(Tree::genTree($categories));

        $flags = $this->flag->index();
        return view('back.article.create', compact('select', 'flags'));
    }
    ...
    public function edit($id)
    {
        ...
        $flags = $this->flag->index();
        $categories=Meta::all()->toArray();
        $select=Tree::dropDownSelect(Tree::genTree($categories),$article->category_id);
        return view('back.article.edit', ['data' => $article, 'select' => $select, 'flags' => $flags]);
    }
